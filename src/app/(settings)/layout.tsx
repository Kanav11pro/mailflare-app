    ...
    <AuthGuard>
      ...
      <MailboxProvider>
        <ComposeProvider>
          <MailSearchProvider>
            <ShortcutsProvider>
            <div className="grid h-[100dvh] grid-cols-[var(--sidebar-width)_minmax(0,1fr)] overflow-hidden bg-[#f6f8fc] dark:bg-[#0f1015] transition-[grid-template-columns] duration-200">
